        ...
        >
          ...
          <div className="space-y-4 relative z-10 flex flex-col items-center">
            <img 
              ...
              alt="Future Radio" 
              className="h-[180px] md:h-[220px] object-contain mx-auto select-none pointer-events-none drop-shadow-2xl transition-transform duration-700 hover:scale-105 filter brightness-0 invert" 
            />
