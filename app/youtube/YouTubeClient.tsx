        ...
        >
          {[...Array(6)].map((_, i) => (
            <React.Fragment key={i}>
              ...
              <span className="mr-6">STREAM OUR SONGS ON:</span> <span className="inline-flex items-center gap-8 text-3xl font-bold align-middle translate-y-[-2px]"><span className="flex items-center gap-3"><img src="/images/logos/spotify.png" className="h-10 w-10 object-contain rounded-full bg-black" /> SPOTIFY</span> <span className="flex items-center"><img src="/images/logos/applemusic.svg" className="h-10 object-contain" /></span> <span className="flex items-center gap-3"><img src="/images/logos/youtubemusic.svg" className="h-10 w-10 object-contain" /> YOUTUBE MUSIC</span> <span className="bg-[#2bc5b4] text-white px-4 py-1 rounded-lg tracking-normal">JioSaavn</span> <span className="bg-[#e72c30] text-white px-4 py-1 rounded-lg tracking-normal">Gaana</span> <span className="bg-[#232f3e] text-[#00a8e1] px-4 py-1 rounded-lg border-2 border-[#00a8e1] tracking-normal lowercase">amazon music</span></span><span className="text-[#E5FF00] ml-12 mr-8 text-4xl">✦</span>100% AUTONOMOUS PREMIUM FOLK RADIO
