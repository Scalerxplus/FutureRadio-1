      ...
      <main className="w-full max-w-[430px] min-h-screen bg-[#0a0a0f] text-white flex flex-col justify-between relative overflow-x-hidden shadow-[0_0_50px_rgba(0,0,0,0.8)] border-x border-[#111118]">
        ...
        <header className="sticky top-0 z-30 bg-[#0a0a0f]/90 backdrop-blur-md border-b border-[#2a2a35] px-5 py-4 space-y-4">
          ...
          <div className="flex justify-between items-center">
            <h1 className="text-xl font-extrabold tracking-tight select-none">
              Whatsup <span className="text-brand-teal">News</span>
            </h1>
            ...
            <div className="flex items-center gap-3.5 text-gray-400 select-none">
              ...
              <button
                ...
                className={`w-7 h-7 rounded-full flex items-center justify-center text-xs border transition-all duration-300 transform active:scale-95 ${
                  user
                    ? isYtPremium
                      ? "bg-[#1d9e75]/15 border-[#1d9e75]/35 text-brand-teal shadow-[0_0_8px_rgba(29,158,117,0.2)]"
                      : "bg-brand-purple/15 border-brand-purple/35 text-brand-purple shadow-[0_0_8px_rgba(127,119,221,0.2)]"
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full bg-[#111118] border border-[#2a2a35] focus:border-brand-teal/40 rounded-lg py-1.5 pl-3.5 pr-8 text-xs font-semibold text-white placeholder-gray-500 outline-none transition duration-200"
              />
              {searchQuery && (
                <button
            ...
            <div className="flex items-center gap-1 bg-[#1d9e75]/10 border border-[#1d9e75]/25 text-[#1d9e75] px-2.5 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider select-none">
              ...
              return (
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full text-xs font-bold whitespace-nowrap transition-all duration-200 border ${
                    isActive
                      ? "bg-brand-teal text-white border-transparent shadow-[0_0_10px_rgba(29,158,117,0.3)] scale-105"
        ...
        <section className="flex-1 px-5 py-6 space-y-6 pb-32 overflow-y-auto">
          ...
          <div ref={sentinelRef} className="h-6 flex items-center justify-center select-none opacity-40">
            ...
            <span className="w-2 h-2 rounded-full bg-brand-teal animate-bounce delay-100 mx-1" />
            <span className="w-2 h-2 rounded-full bg-brand-teal animate-bounce delay-200" />
          </div>
        </section>
