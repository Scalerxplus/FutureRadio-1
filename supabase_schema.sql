...
-- Run this in your Supabase SQL Editor to set up all tables and Row Level Security (RLS) policies.
...
-- Add some seed data for Articles (optional, but highly recommended)
...
-- Add seed data for Playlist Blocks (optional, but highly recommended)
