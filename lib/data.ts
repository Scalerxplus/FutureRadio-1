...
export const REGIONAL_STATIONS = [
  { id: 'bagheli_3', name: 'Bagheli Vibes', region: 'Vindhya Region', listeners: '2.1k', comingSoon: false, image: '/assets/stations/bagheli_artwork.png', color: '#9B59B6' },
...
export const INDIE_STATIONS = [
  { id: 'indie', name: 'Indie Vibes', region: 'Independent', listeners: '18k+', comingSoon: false, image: '/assets/stations/indie_artwork.jpg', color: '#FF69B4' },
];
